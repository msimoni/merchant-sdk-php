...
class Syspay_Merchant_Entity_PaymentRecipient extends Syspay_Merchant_Entity
{
    ...
    /**
     * Gets the Number of seconds to delay the transfer's settlement
     * (added to the actual time of settlement of the payment).
     *
     * @return integer
     */
    ...
    /**
     * Sets the Number of seconds to delay the transfer's settlement
     * (added to the actual time of settlement of the payment).
     *
